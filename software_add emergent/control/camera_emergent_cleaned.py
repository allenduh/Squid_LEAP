...
class Camera(object):
    ...
    def start_cont_acquisition_and_save(self):
        ...
        print("Reach max_frames_save Acquisition stopped.")
        print("dropped_frame = ", dropped_frame)
    ...
    def saving_worker(self):
        ...
        while self.is_streaming and save_idx < self.max_frames_save:
            try:
                ...
                if allocate_idx >= self.batch_size:
                    ...
                    print(f"{self.output_path}/batch_{save_idx} iing")
    ...
    def cont_acquisition(self):  ## Maybe useless
