...
class LiveControlWidget(QFrame):
    ...
    def toggle_live(self,pressed):
        if pressed:
            print(self.dropdown_triggerManu.currentText())
...
class RecordingWidget(QFrame):
    ...
    def toggle_recording(self,pressed):
        ...
        if pressed:
            ...
            # save_fps = self.entry_saveFPS.value()
            # time_limit = self.entry_timeLimit.value()


            # save_dir = f"{self.imageSaver.base_path}/{self.lineEdit_experimentID.text()}"
            # print(save_dir)
 
            # # Define the command as a list of arguments
            # command = [
            #     r"C:\Program Files\EVT\eSDK\tools\multistream.exe",
            #     "-c", "1",
            #     "-t", str(time_limit),
            #     "-f", str(int(save_fps)),
            #     "-d", "2",
            ...
            # ]
            # cd C:\Program Files\EVT\eSDK\tools
            # C:\Program Files\EVT\eSDK\tools>multistream.exe -c 1 -t 10 -f 1500 -d 2 -v 10@-1@C:/Users/user/Downloads/@1  
            # >multistream.exe -c 1 -t 10 -f 1500 -d 2 -j u,LineTime,346 -v 10@-1@C:/Users/user/Downloads/@1
            # C:\Program Files\EVT\eSDK\tools>multistream.exe -c 1 -t 10 -f 1500  -j u,LineTime,341 -j u,Bin,2 -d 2 @-1@d:\save1@1
            # multistream.exe -c 1 -t 1 -f 1500  -d 2 -v 10@-1@d:\save1@1
            # multistream.exe -c 1 -t 1 -f 1500 -j u,LineTime,341 -d 2 -v 10@-1@d:\save1@1

            
# multistream.exe -c 1 -t 1 -f 1500 -j u,LineTime,3401 -j u,Width,2048  -d 2 -v 10@-1@d:\save1@1
# multistream.exe -c 1 -t 1 -f 1500 -j u,LineTime,3401 -j u,Width,max  -d 2 -v 10@-1@d:\save1@1
# multistream.exe -c 1 -t 1 -f 1500 -j u,LineTime,3401 -j u,Width,min  -d 2 -v 10@-1@d:\save1@1
# multistream.exe -c 1 -t 1 -f 1500 -j u,LineTime,min -j u,Width,max -j u,Height,max  -d 2 -v 10@-1@d:\save1@1

# multistream.exe -c 1 -t 1 -f 1500  -j u,Line Time,341 -j u,Exposure,1000  -d 2 -v 10@-1@d:\save1@1
# multistream.exe -c 1 -t 1 -f 1500  -j u,Exposure,482 -j u,FrameRate,1600  -d 2 -v 10@-1@d:\save1@1
# multistream.exe -c 1 -t 1 -j u,Exposure,482 -j u,FrameRate,1500 -j u,LineTime,262 -d 2 -v 10@-1@d:\save1@1  ##no problem
# multistream.exe -c 1 -t 1 -e 2,8 -j u,Exposure,482 -j u,FrameRate,1600 -j u,LineTime,262 -d 2 -v 10@-1@d:\save1@1  ##no problem
# multistream.exe -c 1 -t 1 -e 2,8 -j u,Exposure,400 -j u,FrameRate,2000 -j u,LineTime,226 -d 2 -v 10@-1@d:\save1@1  ##benchmark!!!
# multistream.exe -c 1 -t 10 -e 4,8 -j u,Exposure,400 -j u,FrameRate,2000 -j u,LineTime,226 -d 2 -v 10@-1@d:\save1@1
# multistream.exe -c 1 -t 1 -e 4,8 -j u,Exposure,400 -j u,FrameRate,2000 -j u,LineTime,250 -d 2 -v 10@-1@d:\save1@1
# multistream.exe -c 1 -t 1 -e 4,8 -j u,Exposure,400 -j u,FrameRate,2000 -j u,LineTime,260 -d 2 -v 10@-1@d:\save1@1

# multistream.exe -c 1 -t 1 -e 4,8 -j u,Exposure,400 -j u,FrameRate,2000 -j u,LineTime,260 -d 2 -v 9@-1@d:\save1@1
# multistream.exe -c 1 -t 1 -e 4,8 -j u,Exposure,400 -j u,FrameRate,2000 -j u,LineTime,260 -d 2 -v 12@-1@d:\save1@1
# multistream.exe -c 1 -t 1 -e 1,1 -j u,Exposure,400 -j u,FrameRate,2000 -j u,LineTime,max -j e,Bin,2x2 -d 2 -v 12@-1@d:\save1@1
# multistream.exe -c 1 -t 1 -e 1,1 -j u,Exposure,400 -j u,FrameRate,2000 -j u,LineTime,max -d 2 -v 12@-1@d:\save1@1
# multistream.exe -c 1 -t 1 -e 1,2 -d 2 -v 12@-1@d:\save1@1
# multistream.exe -c 1 -t 10 -e 4,8 -j u,LineTime,max -d 2
# multistream.exe -c 1 -t 10 -e 4,8 -j u,Exposure,max -j u,FrameRate,3000 -j u,LineTime,max -d 2
            # try:
            #     # Run the command
...
class RecordingWidget_OG(QFrame):
    def __init__(self, streamHandler, imageSaver, main=None, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.imageSaver = imageSaver # for saving path control
        self.streamHandler = streamHandler
